...
- Click on the "RuneScape" bottle under "Your Bottles"
- Click "Run Executable...", and select `RuneScape-Setup.exe`
...
- Note: If you're not sure if you did this correctly, launch a terminal and run the following script:
